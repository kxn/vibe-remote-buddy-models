...
声明式遥控器配置与贡献入口。当前库版本 **0.1.1**，格式 **1**。资源独立版本化；RC003 指纹已补采至 revision **2**。
...
| xiaomi.rc003 | atvv.rc003 | 原内置映射，13键 | 完整86B Map、8个报告引用及ATVV通道已补采 |
...
RC003 补采来源和未验证项目见 [实机记录](evidence/xiaomi.rc003.md)。旧 revision 1 保留为历史记录，不能作为强指纹自动确认。
